...
class TestVBST:
    ...
    def test_tree_construction(self):
        ...
        tree_structure = vbst.inorder_tree_structure(vbst.root)
    ...
    def test_upsert_insert(self):
        vbst = self.vbst
        vbst.upsert_vnode(int_to_bytes(60), int_to_bytes(60))
        vbst.upsert_vnode(int_to_bytes(40), int_to_bytes(40))
        vbst.upsert_vnode(int_to_bytes(10), int_to_bytes(10))
        vbst.upsert_vnode(int_to_bytes(20), int_to_bytes(20))
        vbst.upsert_vnode(int_to_bytes(80), int_to_bytes(80))
    ...
    def test_upsert_update(self):
        vbst = self.vbst
        vbst.upsert_vnode(int_to_bytes(50), int_to_bytes(500))
        vbst.upsert_vnode(int_to_bytes(150), int_to_bytes(1500))
    ...
    def test_upsert_root(self):
        vbst = self.vbst
        vbst.upsert_vnode(int_to_bytes(100), int_to_bytes(1000))
    ...
    def test_delete_leaf(self):
        vbst = self.vbst
        vbst.delete_vnode(int_to_bytes(80))
    ...
    def test_delete_single_parent(self):
        vbst = self.vbst
        vbst.delete_vnode(int_to_bytes(10))
    ...
    def test_delete_full_parent(self):
        vbst = self.vbst
        vbst.delete_vnode(int_to_bytes(50))
    ...
    def test_delete_root(self):
        vbst = self.vbst
        vbst.delete_vnode(int_to_bytes(100))
